package ru.shevtsov.caloriesmng.repository.jdbc;
...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    public JdbcUserMealRepositoryImpl(DataSource dataSource) {
        this.insertUser = new SimpleJdbcInsert(dataSource).withTableName("meals").usingGeneratedKeyColumns("id");
    }
    ...
    public UserMeal get(int id, int userId) {
        List<UserMeal> userMeals = jdbcTemplate.query("SELECT * FROM meals WHERE id=? AND userId=?", ROW_MAPPER, id, userId);
